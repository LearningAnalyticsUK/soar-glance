...
ALTER TABLE surveys RENAME TO survey;
...
ALTER TABLE surveys_students RENAME TO survey_student;
...
ALTER TABLE survey_queries RENAME TO survey_query;
...
ALTER TABLE surveys_respondents RENAME TO survey_respondent;
