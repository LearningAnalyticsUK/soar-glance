...
# First we need to execute sbt-docker on the three relevant modules
sbt "glance-evalJS/docker; glance-evalJVM/docker"
...
docker compose -f ../docker-compose.yml up glance-eval-db
