...
CREATE TABLE IF NOT EXISTS survey_visualisation (
  survey_id VARCHAR(40) NOT NULL CONSTRAINT survey_visualisation_fkey REFERENCES survey,
  visualisation_id VARCHAR(128) NOT NULL CONSTRAINT visualisation_survey_fkey REFERENCES visualisation,
